...
# Display Firmware
PRODUCT_COPY_FILES += \
        $(LOCAL_PATH)/prebuilts/bin/gpu_dcvsd:system/bin/gpu_dcvsd \
        ...
        $(LOCAL_PATH)/prebuilts/lib/egl/libEGL_adreno.so:system/lib/egl/libEGL_adreno.so \
        $(LOCAL_PATH)/prebuilts/lib/egl/libGLESv1_CM_adreno.so:system/lib/egl/libGLESv1_CM_adreno.so \
        $(LOCAL_PATH)/prebuilts/lib/egl/libGLESv2_adreno.so:system/lib/egl/libGLESv2_adreno.so \
        $(LOCAL_PATH)/prebuilts/lib/egl/libplayback_adreno.so:system/lib/egl/libplayback_adreno.so \
        $(LOCAL_PATH)/prebuilts/lib/egl/libq3dtools_adreno.so:system/lib/egl/libq3dtools_adreno.so \
        $(LOCAL_PATH)/prebuilts/lib/libadreno_utils.so:system/lib/libadreno_utils.so \
        ...
        $(LOCAL_PATH)/prebuilts/lib/libCB.so:system/lib/libCB.so \
        ...
        $(LOCAL_PATH)/prebuilts/lib/libllvm-arm.so:system/lib/libllvm-arm.so \
